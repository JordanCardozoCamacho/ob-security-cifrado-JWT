...
import com.jordan.obsecuritycifradoJWT.repository.CarRepository;
...
public class CarServiceImpl implements CarService {
    ...
    public List<Car> findByDoors(Integer doors) {
        ...
        if(doors < MIN_DOORS){
            log.info("Trying to sarch less than allowed doors");
    ...
    @Override
    public List<Car> findByYearIn(List<Integer> year) {
        return this.carRepository.findByYearIn(year);
    }

    @Override
    public List<Car> findByYearBetween(Integer startYear, LocalDate endDate) {
        return this.carRepository.findByYearBetween(startYear, endDate);
    }

    @Override
    public List<Car> findByReleaseBetween(LocalDate startDate, LocalDate endDate) {
        return this.carRepository.findByReleaseBetween(startDate, endDate);
    }
